...
namespace schunk_wsg_driver
{
    ...
    protected:
        ...
        void CommandCB(WSGCommand command)
        {
            ...
            const bool sent = gripper_interface_ptr_->SetTargetPositionSpeedEffort(target_position, max_speed, max_effort);
            if (!sent)
            {
...
int main(int argc, char** argv)
{
    ...
    if (interface_type == "udp")
    {
        ...
        schunk_wsg_driver::SchunkWSGDriver gripper(nh, gripper_interface, command_topic, status_topic);
