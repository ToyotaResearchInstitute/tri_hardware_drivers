...
#ifndef ATI_NETCANOEM_FT_DRIVER_HPP
#define ATI_NETCANOEM_FT_DRIVER_HPP
...
namespace ati_netcanoem_ft_driver
{
    ...
    public:
        ...
        AtiNetCanOemInterface(const std::function<void(const std::string&)>& logging_fn, const std::string& socketcan_interface, const uint8_t sensor_base_can_id);
        ...
        bool LoadNewActiveCalibration(const uint8_t calibration_index);
        ...
        bool SetActiveCalibration(const uint8_t desired_calibration);
    ...
    protected:
        ...
        std::vector<DataElement> SendFrameAndAwaitResponse(const DataElement& command, const uint8_t num_response_frames, const double timeout);
...
#endif // ATI_NETCANOEM_FT_DRIVER_HPP
