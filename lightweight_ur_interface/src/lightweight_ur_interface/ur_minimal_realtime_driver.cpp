...
namespace lightweight_ur_interface
{
    uint64_t URRealtimeState::DeserializeSelf(const std::vector<uint8_t>& buffer, const uint64_t current)
    {
        ...
        const std::pair<std::vector<double>, uint64_t> deserialized_target_position = DeserializeKnownSizeDoubleVector(6, buffer, current_offset);
        target_position_ = deserialized_target_position.first;
        current_offset += deserialized_target_position.second;
        const std::pair<std::vector<double>, uint64_t> deserialized_target_velocity = DeserializeKnownSizeDoubleVector(6, buffer, current_offset);
        target_velocity_ = deserialized_target_velocity.first;
        current_offset += deserialized_target_velocity.second;
        const std::pair<std::vector<double>, uint64_t> deserialized_target_acceleration = DeserializeKnownSizeDoubleVector(6, buffer, current_offset);
        target_acceleration_ = deserialized_target_acceleration.first;
        current_offset += deserialized_target_acceleration.second;
        const std::pair<std::vector<double>, uint64_t> deserialized_target_current = DeserializeKnownSizeDoubleVector(6, buffer, current_offset);
        target_current_ = deserialized_target_current.first;
        current_offset += deserialized_target_current.second;
        const std::pair<std::vector<double>, uint64_t> deserialized_target_torque = DeserializeKnownSizeDoubleVector(6, buffer, current_offset);
        target_torque_ = deserialized_target_torque.first;
        current_offset += deserialized_target_torque.second;
        const std::pair<std::vector<double>, uint64_t> deserialized_actual_position = DeserializeKnownSizeDoubleVector(6, buffer, current_offset);
        actual_position_ = deserialized_actual_position.first;
        current_offset += deserialized_actual_position.second;
        const std::pair<std::vector<double>, uint64_t> deserialized_actual_velocity = DeserializeKnownSizeDoubleVector(6, buffer, current_offset);
        actual_velocity_ = deserialized_actual_velocity.first;
        current_offset += deserialized_actual_velocity.second;
        const std::pair<std::vector<double>, uint64_t> deserialized_actual_current = DeserializeKnownSizeDoubleVector(6, buffer, current_offset);
        actual_current_ = deserialized_actual_current.first;
        current_offset += deserialized_actual_current.second;
        const std::pair<std::vector<double>, uint64_t> deserialized_control_current = DeserializeKnownSizeDoubleVector(6, buffer, current_offset);
        control_current_ = deserialized_control_current.first;
        current_offset += deserialized_control_current.second;
        const std::pair<std::vector<double>, uint64_t> deserialized_actual_tcp_vector = DeserializeKnownSizeDoubleVector(6, buffer, current_offset);
        ...
        const std::pair<std::vector<double>, uint64_t> deserialized_actual_tcp_twist = DeserializeKnownSizeDoubleVector(6, buffer, current_offset);
        ...
        const std::pair<std::vector<double>, uint64_t> deserialized_actual_tcp_wrench = DeserializeKnownSizeDoubleVector(6, buffer, current_offset);
        ...
        const std::pair<std::vector<double>, uint64_t> deserialized_target_tcp_vector = DeserializeKnownSizeDoubleVector(6, buffer, current_offset);
        ...
        const std::pair<std::vector<double>, uint64_t> deserialized_target_tcp_twist = DeserializeKnownSizeDoubleVector(6, buffer, current_offset);
        ...
        const std::pair<std::vector<double>, uint64_t> deserialized_motor_temperature = DeserializeKnownSizeDoubleVector(6, buffer, current_offset);
        ...
        const std::pair<std::vector<double>, uint64_t> deserialized_joint_mode = DeserializeKnownSizeDoubleVector(6, buffer, current_offset);
        ...
        const std::pair<std::vector<double>, uint64_t> deserialized_actual_tcp_acceleration = DeserializeKnownSizeDoubleVector(3, buffer, current_offset);
        ...
        const std::pair<std::vector<double>, uint64_t> deserialized_joint_voltage = DeserializeKnownSizeDoubleVector(6, buffer, current_offset);
